...
class AipFace extends AipBase
{
     ...
     * @return array
     */
    public function addUser(string $image, string $imageType, string $groupId, string $userId, array $options = []): array
    {
        $data = [];
        $data['image'] = $image;
        $data['image_type'] = $imageType;
     ...
     * @return array
     */
    public function updateUser(string $image, string $imageType, string $groupId, string $userId, array $options = []): array
    {
        $data = [];
        $data['image'] = $image;
        $data['image_type'] = $imageType;
     ...
     * @return array
     */
    public function personVerify(string $image, string $imageType, string $idCardNumber, string $name, array $options = []): array
    {
        $data = [];
        $data['image'] = $image;
        $data['image_type'] = $imageType;
