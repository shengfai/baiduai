...
class AipImageSearch extends AipBase
{
     ...
     * @return array
     */
    public function sameHqAdd(string $image, array $options = []): array
    {
        $data = [];
     ...
     * @return array
     */
    public function sameHqAddUrl(string $url, array $options = []): array
    {
        $data = [];
        $data['url'] = $url;
        $data = array_merge($data, $options);
     ...
     * @return array
     */
    public function similarAdd(string $image, array $options = []): array
    {
        $data = [];
        $data['image'] = base64_encode($image);
        $data = array_merge($data, $options);
     ...
     * @return array
     */
    public function similarAddUrl(string $url, array $options = []): array
    {
        $data = [];
        $data['url'] = $url;
        $data = array_merge($data, $options);
     ...
     * @return array
     */
    public function productAdd(string $image, array $options = []): array
    {
        $data = [];
        $data['image'] = base64_encode($image);
        $data = array_merge($data, $options);
     ...
     * @return array
     */
    public function productAddUrl(string $url, array $options = []): array
    {
        $data = [];
        $data['url'] = $url;
        $data = array_merge($data, $options);
